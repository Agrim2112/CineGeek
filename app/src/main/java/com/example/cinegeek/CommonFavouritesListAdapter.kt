...
class CommonFavouritesListAdapter(private val context: Context, private var MoviesList: MutableList<MovieDetails>) : RecyclerView.Adapter<CommonFavouritesListAdapter.ViewHolder>() {
